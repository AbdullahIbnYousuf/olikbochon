...
class SparseNullModel:
    ...
    def __init__(self, candidate: str, *, classifier_c: float = 1.0) -> None:
        ...
        classifier_config = {**LOGISTIC_CONFIG, "C": self.classifier_c}
        self.classifier = LogisticRegression(**classifier_config)
